...
- C’est quoi un triangle équilatéral?
    
    C’est un triangle avec 3 côtés isométriques
    
- C’est quoi un triangle acutangle?
    
    C’est un triangle avec 3 angles aigus
    
- C’est quoi un triangle obtusangle?
    
    C’est un triangle avec un angle obtus
    
- C’est quoi un triangle isoangle?
...
- Est-ce qu’un triangle avec les côtés mesurant: 5cm, 3cm, 2cm est possible? Pourquoi?
