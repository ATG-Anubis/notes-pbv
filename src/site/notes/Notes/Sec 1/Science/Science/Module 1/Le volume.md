---
{"dg-publish":true,"permalink":"/Notes/Sec 1/Science/Science/Module 1/Le volume/","created":"","updated":""}
---
...
- Quels sont les états de la matière?
    ...
    - Superfluide
    - Superconducteur
- Comment fait-on pour calculer le volume d'un solide régulier (un cube, un prisme, une sphère, etc.)?
    - On mesure la longueur fois la largeur fois la hauteur du solide
    - Formule: V = L x l x h
- Comment fait-on pour calculer le volume d'un solide irrégulier petit?
    - Mettre une quantité d'eau dans un cylindre gradué afin de submerger au complet l'objet
- Combien vaut 1 mL en cm3?
    - 1 cm3
- Comment fait-on pour calculer le volume d'un solide irrégulier gros?
...
- Qui a inventé la méthode pour calculer le volume d'un solide irrégulier?
    - Archimède