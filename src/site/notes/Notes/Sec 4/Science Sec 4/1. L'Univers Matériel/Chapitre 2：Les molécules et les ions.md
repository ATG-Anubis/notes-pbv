...
>[!Question]- C'est quoi le solvant?
>C'est ce qui dissout le soluté

>[!Question]- C'est quoi le soluté?
>C'est ce qui se fait dissoudre

>[!Question]- C'est quoi la solution?
>C'est le mélange entre le solvant et le soluté

>[!Question]- C'est quoi la concentration?
>C'est la quantité de soluté par rapport à la quantité de solvant

>[!Question]- C'est quoi la solubilité?
>C'est la limite à la quantité de soluté qu'on peut dissoudre dans un solvant. C'est la concentration maximale.

>[!Question]- Nomme un facteur qui peut influencer la solubilité.
>La température

>[!Question]- Que se passe-t-il si on dépasse la solubilité?
>Le soluté arrêtera de se dissoudre


>[!Question]- C'est quoi la concentration molaire?
>C'est la concentration avec des moles et non des grammes

>[!Question]- Quelle est la formule pour calculer la concentration molaire?
>$$\text{C}=\frac{\text{n}}{\text{v}}$$


>[!Question]- C'est quoi la dissolution?
>C'est le fait d'ajouter du soluté dans le solvant
>>[!Question]- Quel est son impact sur la concentration?
>>La concentration augmente

>[!Question]- C'est quoi la dilution?
>C'est le fait d'ajouter du solvant dans la solution
>>[!Question]- Quel est son impact sur la concentration?
>>La concentration diminue

>[!Question]- C'est quoi l'évaporation?
>C'est le fait d'enlever du solvant de la solution
>>[!Question]- Quel est son impact sur la concentration?
>>La concentration augmente


>[!Question]- Quelle est la formule pour la dissolution?
>$$\text{C}=\frac{\text{m}}{\text{v}}$$

>[!Question]- Quelle est la formule pour la dilution?
>$$\text{C}_{1}\text{V}_{1}=\text{C}_{2}\text{V}_{2}$$

### Le PPM

>[!Question]- Que veut dire PPM?
>Parties par million
